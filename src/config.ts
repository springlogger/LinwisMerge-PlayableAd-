...
export const GUN_SLOT_COUNT = GRID_SIZE * GRID_SIZE - 1;
...
export const WAVE_INTRO_DELAY = 2;
...
export const CAMERA_POS: [number, number, number] = [0, 9.5, 9];
export const ENEMY_SPAWN_RADIUS = 7.0;
